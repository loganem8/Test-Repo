function rot = mp_rotation_accel(accel_matrix, data)
%this function rotates accelerometer data onto anatomical axes. The data
%should be formatted as columns of x, y, and z sensor readings. 
%The accel_matrix input is a rotation matrix oriented such that the
